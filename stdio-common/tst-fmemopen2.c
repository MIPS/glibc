...
do_test_with_buffer (void)
{
  ...
  if (o != nstr)
    {
      printf ("%s: first ftello returned %jd, expected %zu\n",
	      __FUNCTION__, (intmax_t)o, nstr);
      result = 1;
    }
  ...
  if (o != 0)
    {
      printf ("%s: second ftello returned %jd, expected 0\n",
	      __FUNCTION__, (intmax_t)o);
      result = 1;
    }
  ...
  if (o != nstr)
    {
      printf ("%s: third ftello returned %jd, expected %zu\n",
	      __FUNCTION__, (intmax_t)o, nbuf);
      result = 1;
    }
  ...
  if (o != nstr2)
    {
      printf ("%s: fourth ftello returned %jd, expected %zu\n",
	      __FUNCTION__, (intmax_t)o, nstr2);
      result = 1;
    }
  fclose (fp);
