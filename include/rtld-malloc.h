...
/* The dynamic linker needs to use its own minimal malloc before libc
   ...
   __rtld_malloc_init_stubs, and set to the final implementation
...
/* Called after the final self-relocation to activate the real malloc
   implementation.  */
void __rtld_malloc_init_real (void) attribute_hidden;
